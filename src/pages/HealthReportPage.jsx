        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-white transition-colors rounded-lg bg-primary-500 hover:bg-primary-600 disabled:opacity-70"
            >
              {isDownloading ? (
                <>
            ...
            {showDownloadOptions && !isDownloading && (
              <div className="absolute right-0 z-10 mt-2 overflow-hidden bg-white rounded-lg shadow-lg w-44 dark:bg-gray-800">
                <button
