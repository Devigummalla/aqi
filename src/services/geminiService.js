...
export const generateHealthRecommendations = async (userData, aqiData) => {
  ...
  try {
    ...
    2. Age-specific Recommendation: Tailored advice considering the person's age (${age}). Start with an appropriate emoji.
    ...
    4. Time-specific Recommendation: Advice on the best times for outdoor activities based on air quality patterns. Start with an appropriate emoji.
    ...
    return {
      ...
      ageSpecificRecommendation: "Consider your age-related health factors when planning outdoor activities during periods of poor air quality.",
      ...
      timeSpecificRecommendation: "Air quality is typically better in the early morning. Consider scheduling outdoor activities during this time.",
